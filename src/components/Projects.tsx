...
const projects = [
  ...
  },
  {
    id: 4,
    title: "TaskFlow",
    description: "Kanban-style productivity app for managing tasks, projects, and deadlines efficiently.",
  ...
  },
  {
    id: 5,
    title: "FinanceBoard",
    description: "SaaS finance platform with dashboards, budgeting, expense tracking, CSV import, analytics.",
    image: "/projects/financeboard.png",
    tags: ["Next.js", "React", "Finance"],
    link: "#",
    github: "#",
  },
  {
    id: 6,
    title: "Weatherly",
    description: "Weather dashboard providing real-time forecasts, severe alerts, and interactive maps.",
